...
int main()
{
	...
	case 9:
	{
		...
		char frase_92[100] = "oi, tudo bem? 42palavras quarenta-e-duas; cinquenta+e+um";
		printf("\n %s \n", ft_strcapitalize(frase_92));

		char frase_93[100] = "e";
		printf("\n %s \n", ft_strcapitalize(frase_93));
	...
	case 11:
	{
		...
		char a[] = "Oi\nvoce esta bem?";
		printf("Solucao: Oi\\0avoce esta bem?");
		printf("Resultado:\n");
